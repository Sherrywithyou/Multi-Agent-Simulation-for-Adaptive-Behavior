...
from src.trial import NewtonChaseTrialAllCondtionVariouSpeedForModel, NewtonChaseTrialAllCondtionVariouSpeedForModelWithDiffBlocks, \
    isAnyKilled, CheckTerminationOfTrial, RecordEatenNumber
from src.experiment import NewtonExperiment, NewtonExperimentWithDiffBlocks
...
def main():
        ...
        for numSheeps in manipulatedVariables['sheepNums']:
            for sheepConcern in manipulatedVariables['sheepConcern']:
                ...
                def loadPolicyOneCondition(numSheeps, sheepConcern, blockSize):
                    ...
                    blocksIDForSheepObserve = list(range(numSheeps + numWolves, numSheeps + numWolves + numBlocks))
    ...
    trial = NewtonChaseTrialAllCondtionVariouSpeedForModelWithDiffBlocks(screen, killzone, sheepLife, targetColor, numWolves, numBlocks,
                                                           stopwatchEvent, allDrawNewStateFun, recordEaten, modelController,

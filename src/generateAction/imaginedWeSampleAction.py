...
class PolicyForCommittedAgent:
    def __init__(self, policyListBasedOnNumAgentsInWe, softDistribution, getAgentsStatesForPolicy, numOfAgentInPolicyFunctionList = [3]):
        self.policyListBasedOnNumAgentsInWe = policyListBasedOnNumAgentsInWe
        self.softDistribution = softDistribution
        self.getAgentsStatesForPolicy = getAgentsStatesForPolicy
        self.numOfAgentInPolicyFunctionList = numOfAgentInPolicyFunctionList
        
    def __call__(self, state, goalId, weIds):

        numAgentsInWe = len(weIds) 
        policyFunctionIndexInList = self.numOfAgentInPolicyFunctionList.index(numAgentsInWe)
